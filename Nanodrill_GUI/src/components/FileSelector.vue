...
<template>
  <div class="w-[350px] h-full bg-white shadow-md flex flex-col border-r border-neutral-200">
    <div class="flex items-center px-4 py-3 bg-neutral-100 border-b border-neutral-200">
