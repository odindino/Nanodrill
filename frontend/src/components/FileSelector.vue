...
<template>
  <div class="file-selector">
    <div class="selector-header">
      <button class="collapse-button" @click="$emit('close')">
    ...
    <div class="selector-content">
      <button class="select-folder-button" @click="openFolderDialog">
        選擇資料夾
      </button>
      
      <div class="path-display" v-if="folderPath">
        <div class="path-label">當前路徑:</div>
        <div class="path-value">{{ folderPath }}</div>
      </div>
    </div>
        ...
        <table>
          ...
          <tbody>
            <tr 
              ...
              :key="file.path"
              :class="{ 'has-dat': file.hasDatFile, 'selected': isSelected(file) }"
            >
              <td>
                <div class="file-name">
